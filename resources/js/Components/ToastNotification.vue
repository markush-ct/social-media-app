...
const toastType = computed(() => {
    return {
        status: "fixed z-50 top-20 lg:right-3 -right-1/2 transform -translate-x-1/2 lg:transform-none p-3 w-full lg:max-w-[30%] bg-green-800 rounded-md flex gap-2 items-start justify-between bg-opacity-80 outline outline-1 outline-green-600",
